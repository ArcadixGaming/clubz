      ...
      <div className="flex-grow">
        ...
        <div className="bg-aicon min-h-screen overflow-hidden bg-auto bg-left-bottom bg-no-repeat">
          <div className="relative my-20">
            <div className="clip-right absolute right-0 top-0 z-50 hidden h-[600px] w-[450px] bg-zinc-900 text-white">
            ...
            <div className="relative pt-16">
              <div className="absolute right-0 flex w-fit overflow-x-auto rounded-md bg-zinc-800 scrollbar-default">
